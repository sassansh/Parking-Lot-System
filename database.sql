...
(
    Parking_Slip_ID char(255) NOT  NULL,
...
(
    Parking_Pass_ID char(255) NOT  NULL,
    Issue_Date_Time datetime NOT  NULL,
    Expiry_Date_Time datetime NOT  NULL,
    Space_ID integer NOT  NULL,
    Lot_ID char(255) NOT  NULL,
    Customer_ID char(255) NOT  NULL,
    PRIMARY KEY (Parking_Pass_ID),
    FOREIGN KEY (Lot_ID) REFERENCES Parking_Lot(Lot_ID) ON DELETE CASCADE,
    FOREIGN KEY (Space_ID) REFERENCES Parking_Space(Space_ID) ON DELETE CASCADE,
    FOREIGN KEY (Customer_ID) REFERENCES Customer(Customer_ID) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (Employee_ID) REFERENCES Parking_Lot_Employee(Employee_ID) ON DELETE CASCADE,
    FOREIGN KEY (Manager_Type) REFERENCES Manager_Salary(Manager_Type) ON UPDATE CASCADE
);
...
(
    ...
    Issue_Date_Time DATETIME NOT NULL,
    Must_Be_Paid_By_Date DATE NOT NULL,
    Date_Time_Paid_On DATETIME,
    FOREIGN KEY (Officer_ID) REFERENCES Officer(Officer_ID),
    FOREIGN KEY (Customer_ID) REFERENCES Customer(Customer_ID),
    FOREIGN KEY (Fine_Type) REFERENCES Fine_Cost(Fine_Type)
);

CREATE TABLE Fine_Cost
(
...
(
    ...
    FOREIGN KEY (Fine_Type) REFERENCES Fine_Type_Cost(Fine_Type) ON UPDATE CASCADE
);
