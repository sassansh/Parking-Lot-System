<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="min-height: 1080px">
  <div class="sidebar-sticky pt-3">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="passholder.php">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
          Pass Holders <span class="sr-only">(current)</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="parkingpass.php">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
          Parking Passes <span class="sr-only">(current)</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="countofficers.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="fine.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="rateUpdate.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="availablelots.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="selectparkingspace.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="insertparkingspace.php">
